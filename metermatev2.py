...
configuration_file = r"C:\Users\Deodat\Desktop\Metermate v2\Metermate_config.txt"
src_fldr = None
dst_fldr = None
db_location = None
...
try:
    con = pypyodbc.connect(
        'DRIVER={Microsoft Access Driver (*.mdb)};UID=admin;UserCommitSync=Yes;Threads=3;SafeTransactions=0;PageTimeout=5;MaxScanRows=8;MaxBufferSize=2048;{FIL=MS Access};DriverId=25;DefaultDir=C:/Users/Deodat/Desktop/Metermate v2/Database;DBQ=C:/Users/Deodat/Desktop/Metermate v2/Database/metermateDB.mdb;')
    cursor = con.cursor()
